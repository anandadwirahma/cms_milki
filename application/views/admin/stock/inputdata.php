        ...
        <form role="form" class="form-horizontal" action="<?php echo base_url() ?>admin/stock/<?=$url;?>" method="post" enctype="multipart/form-data">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" name="description" data-validation="required" class="form-control" value="<?php echo $description; ?>" placeholder="Description">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" name="url_img" id="url_img" data-validation="required" class="form-control" value="<?php echo $url_img; ?>" placeholder="https://milki/milki-coklat.png">
              </div>
            </div>
            <div class="form-group">
...
<script>
    $(document).ready(function () {
        $('#submit-form').click(function(){
          if ($('#url_img').val() != '') {
              if ($('#url_img').val().substring(0, 5) == 'https' && ($('#url_img').val().slice(-4) == '.jpg' || $('#url_img').val().slice(-4) == '.png')) {
                    return true;
              }else {
