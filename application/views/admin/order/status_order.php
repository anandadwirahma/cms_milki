                            ...
                            <ul class="timeline">
                                ...
                                <li>
                                    ...
                                    ?>
                                        <div class="timeline-item">
                                            <span class="time">
                                                <?php foreach ($getTracker as $v_track) { if($v_track->status == 'delivered') { ?>
                                                <i class="fa fa-clock-o"></i>
                                                <?php echo $v_track->datetime; }} ?>
                                            </span>
                                            <h3 class="timeline-header">Your order is received.</h3>
                                            <div class="timeline-body">
                                                <?php foreach ($detailReceive as $v_receive) { 
                                                        if ($v_receive->receiver == '') {
                                                            echo '';
                                                        } else {
                                                ?> 
                                                            Received By : <?php echo $v_receive->receiver;?>
                                                            </br>
                                                            Receive Time : <?php echo $v_receive->receivedate;?>
                                                            </br> </br>
                                                            <font color="red"><b></b><?php if($v_receive->status == '4') { echo '*Need Confirm Customer'; } ?></font>
                                                <?php 
                                                        }
                                                    } 
                                                ?>
