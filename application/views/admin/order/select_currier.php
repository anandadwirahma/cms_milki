    ...
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <form role="form" class="form-horizontal" action="<?php echo base_url() ?>admin/order/process_currier" method="post">
...
<script>
  $(document).on("click", "#selectCurrier", function () {
    ...
    $.ajax({
      url: "<?php echo site_url('admin/order/curriertask');?>",
      type: "POST",
      data: {
        currierid: currierid,
      },
    ...
    if (checked.checked) {
      for (var i = 0; i < ckName.length; i++) {
        ...
        if (!ckName[i].checked) {
          ...
          document.getElementById('orderid').value = $(ckType).attr('id_order');
